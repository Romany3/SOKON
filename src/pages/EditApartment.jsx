...
export const EditApartment = () => {
  ...
  useEffect(() => {
    const fetchApartment = async () => {
      try {
        ...
        setErrors({ fetch: 'Failed to load apartment details' });
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setErrors({ submit: getApiErrorMessage(requestError, 'Failed to update apartment. Please try again.') });
    } finally {
    ...
    return (
      <div className="w-full min-h-screen bg-[#f8fafc]">
        ...
        <div className="flex flex-col items-center justify-center h-[80vh]">
          ...
          <p className="mt-4 text-slate-500 font-bold uppercase tracking-widest">Loading details...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="w-full min-h-screen bg-[#f8fafc]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className="mb-10 text-center">
          <h1 className="text-4xl font-black text-slate-900 mb-2">Edit Apartment</h1>
          <p className="text-slate-500">Update your property listing details</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-[32px] shadow-sm border border-slate-100 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className={`border-2 border-dashed ${errors.images ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-primary bg-slate-50'} rounded-3xl p-8 text-center cursor-pointer transition`}>
                  ...
                  <label htmlFor="images" className="cursor-pointer block">
                    ...
                    <p className="text-slate-700 font-bold">Add More Photos</p>
              ...
              {/* Video Upload */}
              <div>
                <label className="block text-slate-700 font-bold mb-4">Apartment Video</label>
                <div className={`border-2 border-dashed border-slate-200 hover:border-primary bg-slate-50 rounded-3xl p-8 text-center cursor-pointer transition`}>
                  <input
                    type="file"
                    accept="video/*"
                    onChange={(e) => {
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <button
              ...
              className="flex-1 bg-primary text-white font-black py-4 rounded-2xl shadow-lg shadow-primary/30 hover:opacity-90 transition disabled:opacity-50"
            >
              {submitLoading ? (
